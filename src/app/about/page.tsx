    ...
    <div className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="prose prose-gray max-w-none">
        <p className="text-lg text-gray-500 mb-4">
          Hey! I&apos;m a Tesla owner who got tired of generic &quot;best accessories&quot; 
        ...
        <ul className="list-disc pl-6 space-y-2 text-gray-500">
          ...
          <li><strong>Real photos</strong> — taken in my actual Tesla</li>
          <li><strong>Real opinions</strong> — no paid sponsorships or fake reviews</li>
          <li><strong>Model-specific</strong> — compatibility verified for each Tesla model</li>
        </ul>
