...
const staticRoutes = [
  ...
  "/guides/tesla-model-y-spare-tire-kit",
  "/reviews",
  "/reviews/charging",
  ...
  "/reviews/frunk",
  "/reviews/frunk/best-tesla-model-y-juniper-frunk-organizer",
  "/reviews/steering-wheel",
  "/reviews/steering-wheel/s3xy-knob-buttons-review",
  "/reviews/sunshades",
