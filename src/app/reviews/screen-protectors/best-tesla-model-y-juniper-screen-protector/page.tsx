      ...
      <section className="space-y-6 mb-10">
        ...
        <div className="border border-zinc-700 rounded-2xl p-6">
          ...
          <div className="flex items-center gap-3 mt-4 flex-wrap">
            ...
            <a href="https://www.amazon.com/s?k=TPARTS+Tesla+Model+Y+Juniper+screen+protector&tag=teslamodelguy-20" target="_blank" rel="noopener noreferrer" className="text-sm bg-white text-zinc-900 px-6 py-3 rounded-lg font-medium hover:bg-zinc-200 transition">Check Amazon →</a>
          </div>
        </div>
        ...
        <div className="border border-zinc-700 rounded-2xl p-6">
          ...
          <div className="flex items-center gap-3 mt-4 flex-wrap">
            ...
            <a href="https://www.amazon.com/s?k=Tesery+Tesla+Model+Y+screen+protector+matte&tag=teslamodelguy-20" target="_blank" rel="noopener noreferrer" className="text-sm bg-white text-zinc-900 px-6 py-3 rounded-lg font-medium hover:bg-zinc-200 transition">Check Amazon →</a>
