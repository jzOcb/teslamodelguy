  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-16">
      ...
      <section className="space-y-6 mb-10">
        ...
        <div className="border border-zinc-700 rounded-2xl p-6">
          ...
          <div className="flex items-center gap-3 mt-4 flex-wrap">
            ...
            <a href="https://www.amazon.com/dp/B0CPDLRCXX?tag=teslamodelguy-20" target="_blank" rel="noopener noreferrer" className="text-sm bg-white text-zinc-900 px-6 py-3 rounded-lg font-medium hover:bg-zinc-200 transition">Check Amazon →</a>
          </div>
        </div>
      ...
      <section className="bg-zinc-900 rounded-2xl p-6 mb-10">
        ...
        <a href="https://www.amazon.com/dp/B0CPDLRCXX?tag=teslamodelguy-20" target="_blank" rel="noopener noreferrer" className="text-sm text-blue-400 hover:text-blue-300 hover:underline">Find rear screen protectors on Amazon →</a>
      </section>
